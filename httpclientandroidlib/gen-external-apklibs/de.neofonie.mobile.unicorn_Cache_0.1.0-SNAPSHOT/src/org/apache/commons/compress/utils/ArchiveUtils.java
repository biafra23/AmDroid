...
public class ArchiveUtils {
  ...
  /**
   * Convert a string to Ascii bytes. Used for comparing "magic" strings which need to be independent of the
   * default Locale.
   * 
   * @param inputString
   * @return the bytes
   ...
   */
  public static boolean isEqual(final byte[] buffer1,
                                final int offset1,
                                final int length1,
                                final byte[] buffer2,
                                final int offset2,
   ...
   * @return <code>true</code> if buffer1 and buffer2 have same contents, having regard to trailing nulls
   */
  public static boolean isEqualWithNull(final byte[] buffer1,
                                        final int offset1,
                                        final int length1,
                                        final byte[] buffer2,
                                        final int offset2,
