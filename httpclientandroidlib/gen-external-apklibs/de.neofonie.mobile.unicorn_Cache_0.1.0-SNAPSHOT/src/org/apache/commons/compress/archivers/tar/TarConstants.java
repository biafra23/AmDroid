 ...
 * 
 * For tar formats (FORMAT_OLDGNU, FORMAT_POSIX, etc.) see GNU tar <I>tar.h</I> type <I>enum
 * archive_format</I>
 */
...
public interface TarConstants {
  ...
  /**
   * LF_ constants represent the "link flag" of an entry, or more commonly, the "entry type". This is the
   * "old way" of indicating a normal file.
   */
  byte   LF_OLDNORM                    = 0;
